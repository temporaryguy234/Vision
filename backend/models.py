...
class TemplateAsset(BaseModel):
    ...
    duration: Optional[float] = Field(default=None, ge=0.0, description="Duration in seconds for video/animation assets")
    frame_rate: Optional[int] = Field(default=None, ge=1, le=120, description="Frame rate for video assets")
