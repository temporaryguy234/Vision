...
def test_files_with_same_name_do_not_collide(tmp_path):
    ...
    with TestClient(app) as client:
        resp1 = client.post(
            ...
            files={"file": ("duplicate.json", file_content_1, "application/json")},
            data={"source": "upload"},
            headers=headers,
        )
        ...
        resp2 = client.post(
            "/api/templates/upload",
            files={"file": ("duplicate.json", file_content_2, "application/json")},
            data={"source": "upload"},
            headers=headers,
        )
